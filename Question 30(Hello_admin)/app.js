...
var user_name = ["hamza", "yasir", "tabish", "admin", "waheed"];
for (var _i = 0, user_name_1 = user_name; _i < user_name_1.length; _i++) {
    var greet = user_name_1[_i];
    if (greet == "admin") {
        console.log("Hello admin, would you like to see a status report?");
    }
    else {
        console.log("Hello ".concat(greet, ", thank you for logging in again"));
    }
}
